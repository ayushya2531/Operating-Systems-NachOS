...
extern void Cleanup();				// Cleanup, called when
						// Nachos is done.
extern int max_burst; //max cpu burst length
extern int min_burst; //min cpu burst length
extern int number_bursts; //number of cpu bursts
extern int s_algo;   //scheduling algo
extern int mte;      //main thread execution time
extern int total_wait; //total waiting time in ready queue
extern int total_burst; //total cpu burst
extern int current_burst; //current cpu burst of currentThread
extern int error;
...
extern int completion_time[];		// Marks completion time of each thread
